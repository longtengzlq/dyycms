...
class Index extends Base
{
    public function index()
    {
       ...
       $rec_arts= Article::name('article')->where(array('language_id'=>'1','status'=>1,'is_recommend'=>1))->where('thumb', 'neq', '')->paginate(10);
       $latest_arts= Article::name('article')->where(array('language_id'=>'1','status'=>1))->where('thumb', 'neq', '')->limit(10)->select();
       
       $links=db('links')->where('language_id',1)->limit(6)->select();
