<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"C:\myweb\TP\public/../application/admin\view\auth_group\edit.html";i:1495959160;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('admin/lst',''); ?>"><?php echo \think\Lang::get('administrator'); ?></a>
                        </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="<?php echo url('AuthGroup/edit'); ?>" method="post">
                           <input name="id" required=""  type="hidden" value="<?php echo $result['id']; ?>" class="form-control">
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label no-padding-right"><?php echo \think\Lang::get('auth_group'); ?></label>
                            <div class="col-sm-6">
                                <span class="input-icon icon-right inverted">
                                    <input name="title" required=""  type="text" value="<?php echo $result['title']; ?>" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <input class="checkbox-slider colored-success "  id='status'  name='status'<?php if($result['status'] == 1): ?>checked="checked" <?php endif; ?>type="checkbox" >
                                    <span class="text" style="margin-top:5px"></span>
                                </label>
                            </div>                            
                        </div>
                      <div class="form-group">
                            <label for="rulse" class="col-sm-2 control-label no-padding-right"><?php echo \think\Lang::get('auth_group_rules'); ?></label>
                            <div class="col-sm-6">  
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <label >
                                                    <input name="rules[]" dataid="id-<?php echo $vo['dataid']; ?>"  type="checkbox" <?php if(in_array(($vo['id']), is_array($rules_arr)?$rules_arr:explode(',',$rules_arr))): ?>checked<?php endif; ?> class="colored-success  checkbox-parent <?php if($vo['level'] != 0): ?> checkbox-child <?php endif; ?> " data-tog='ss'  value='<?php echo $vo['id']; ?>'>
                                                    <span id="check-2 " class="text"></span>
                                                </label>  
                                                <?php if($vo['level'] == 0): ?>
