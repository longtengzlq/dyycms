                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>"><?php echo \think\Lang::get('system'); ?></a>
                                        ...
                                        <li class="active"><?php echo \think\Lang::get('auth_group_list'); ?></li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="<?php echo \think\Lang::get('add'); ?>" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('auth_group/add'); ?>'"> <i class="fa fa-plus"></i> <?php echo \think\Lang::get('add'); ?>
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover ">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center"><?php echo \think\Lang::get('auth_group_title'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('status'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('auth_rules_ID'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"  style='vertical-align: middle;'><?php echo $vo['title']; ?></td>
                                ...
                                <td align="center"   style='vertical-align: middle;'> 
                                 ...
                                 <td align="center"  style='vertical-align: middle;max-width: 400px;white-space: nowrap;text-overflow:ellipsis;overflow: hidden;'><?php echo $vo['rules']; ?></td>
                                <td align="center" class="buttons-preview"  style='vertical-align: middle;'>
                                    <a href="<?php echo url('authGroup/edit',array('id'=>$vo['id'])); ?>" class="btn btn-azure btn-m " style="margin-bottom: -1px;">
                                        <i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?>
                                    </a>
                                    <a href="#" onClick="warning('<?php echo \think\Lang::get('delete_confirm'); ?>', '<?php echo url('authGroup/del',array('id'=>$vo['id'])); ?>')" class="btn btn-darkorange  btn-m" style="margin-bottom: -1px;">
