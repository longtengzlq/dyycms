<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"C:\myweb\TP\public/../application/admin\view\admin\list.html";i:1495774738;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>"><?php echo \think\Lang::get('system'); ?></a>
                                        ...
                                        <li class="active"><?php echo \think\Lang::get('admin_list'); ?></li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="<?php echo \think\Lang::get('add'); ?>" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('admin/add'); ?>'"> <i class="fa fa-plus"></i> <?php echo \think\Lang::get('add'); ?>
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover ">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center"><?php echo \think\Lang::get('last_log_IP'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('last_log_time'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"  style='vertical-align: middle;'><?php echo $vo['group_id']; ?></td>
                                 <td align="center"  style='vertical-align: middle;'><?php echo $vo['create_IP']; ?></td>
                                <td align="center"  style='vertical-align: middle;'><?php echo date("Y-m-d",$vo['last_log_time']); ?></td>
                                ...
                                <td align="center" class="buttons-preview"  style='vertical-align: middle;'>
                                    <a href="<?php echo url('admin/edit',array('id'=>$vo['id'])); ?>" class="btn btn-azure btn-m " style="margin-bottom: -1px;">
                                        <i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?>
                                    </a>
                            
                                    <a href="#" onClick="warning('<?php echo \think\Lang::get('delete_confirm'); ?>', '<?php echo url('admin/del',array('id'=>$vo['id'])); ?>')" class="btn btn-darkorange  btn-m" style="margin-bottom: -1px;">
