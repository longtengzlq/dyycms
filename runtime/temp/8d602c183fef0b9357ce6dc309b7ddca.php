<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"C:\myweb\TP\public/../application/admin\view\admin\add.html";i:1495946970;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('admin/add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="password" class="col-sm-2 control-label no-padding-right"><?php echo \think\Lang::get('password'); ?></label>
                            <div class="col-sm-6">  
                                <span class="input-icon icon-right inverted">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <input class="checkbox-slider yesno colored-success "  id='status'  name='status' type="checkbox">
                                ...
                                <?php if(is_array($auth_groups) || $auth_groups instanceof \think\Collection || $auth_groups instanceof \think\Paginator): $k = 0; $__LIST__ = $auth_groups;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$group): $mod = ($k % 2 );++$k;if($k%4 == 1): ?>
                                    ...
                                    <?php endif; ?>
                                                <div class="col-lg-3 col-sm-3 col-xs-3">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name='checkbox[]' class="colored-success" value='<?php echo $group['id']; ?>'>
