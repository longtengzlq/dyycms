<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"C:\myweb\TP\public/../application/admin\view\auth_rule\list.html";i:1496065614;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>"><?php echo \think\Lang::get('system'); ?></a>
                                        ...
                                        <li class="active"><?php echo \think\Lang::get('auth_rule_list'); ?></li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="<?php echo \think\Lang::get('add'); ?>" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('authRule/add'); ?>'"> 
    <i class="fa fa-plus"></i> <?php echo \think\Lang::get('add'); ?>
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover ">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center"><?php echo \think\Lang::get('auth_rule_name'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('auth_rule_title'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('status'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('status'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('auth_rules_condition'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"  style='vertical-align: middle; text-align: left;'>
                                      <?php if($vo['level']>0) { echo str_repeat('&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;',$vo['level']-1).'&nbsp;&nbsp;&nbsp; |---';}?><?php echo $vo['name']; ?>
                                    
                                    
                                </td>
                                <td align="center"  style='vertical-align: middle;text-align: left'>
                                    <?php if($vo['level']>0) { echo str_repeat('&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;',$vo['level']-1).'&nbsp;&nbsp;&nbsp; |---';}?><?php echo $vo['title']; ?>
                                </td>
                                ...
                                <td align="center"   style='vertical-align: middle;'> 
                                        ...
                                        <label style="margin-bottom: -5px;">
                                            <input class="checkbox-slider colored-success " style="left: inherit"  onclick="set_status(<?php echo $vo['id']; ?>,this)"  id='type_<?php echo $vo['id']; ?>' data-tog='sdfaf'  name='type' <?php if($vo['type'] == 1): ?>checked="checked"<?php endif; ?> type="checkbox">
                                            <span class="text" style="margin-bottom: 0px"></span>
                                        </label>
                                </td>
                                 <td align="center"  style='vertical-align: middle;'><?php echo $vo['condition']; ?></td>
                                <td align="center" class="buttons-preview"  style='vertical-align: middle;'>
                                    <a href="<?php echo url('authRule/edit',array('id'=>$vo['id'])); ?>" class="btn btn-azure btn-m " style="margin-bottom: -1px;">
                                        <i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?>
                                    </a>
                                    <a href="#" onClick="warning('<?php echo \think\Lang::get('delete_confirm'); ?>', '<?php echo url('authRule/del',array('id'=>$vo['id'])); ?>')" class="btn btn-darkorange  btn-m" style="margin-bottom: -1px;">
