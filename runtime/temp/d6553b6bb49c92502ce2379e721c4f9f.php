<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"C:\myweb\TP\public/../application/admin\view\model_type\add.html";i:1496833019;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('model_type/lst',''); ?>"><?php echo \think\Lang::get('model'); ?></a>
                        </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo url('ModelType/add'); ?>" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span class="input-icon icon-right inverted">
                                    <input name="model_ch_name" required=""  type="text" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">  
                                <span class="input-icon icon-right inverted">
                                    <input name="model_en_name" required="" type="text"  class="form-control ">
