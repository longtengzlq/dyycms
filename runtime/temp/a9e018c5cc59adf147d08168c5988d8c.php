<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"C:\myweb\TP\public/../application/admin\view\model_type\list.html";i:1496824169;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>"><?php echo \think\Lang::get('system'); ?></a>
                                        ...
                                        <li class="active"><?php echo \think\Lang::get('model'); ?></li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="<?php echo \think\Lang::get('add'); ?>" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('ModelType/add'); ?>'"> <i class="fa fa-plus"></i> <?php echo \think\Lang::get('add'); ?>
</button>
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-body">
                    ...
                    <table class="table table-bordered table-hover ">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center"><?php echo \think\Lang::get('model_ch_name'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('model_en_name'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('model_cate_page'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('model_list_page'); ?></th>
                                <th class="text-center"><?php echo \think\Lang::get('model_detail_page'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"  style='vertical-align: middle;'><?php echo $vo['model_ch_name']; ?></td>
                                <td align="center"  style='vertical-align: middle;'><?php echo $vo['model_en_name']; ?></td>
                                 <td align="center"  style='vertical-align: middle;'><?php echo $vo['model_category_page']; ?></td>
                                 <td align="center"  style='vertical-align: middle;'><?php echo $vo['model_list_page']; ?></td>
                                 <td align="center"  style='vertical-align: middle;'><?php echo $vo['model_detail_page']; ?></td>
                                 
                                <td align="center" class="buttons-preview"  style='vertical-align: middle;'>
                                    <a href="<?php echo url('model_type/edit',array('id'=>$vo['id'])); ?>" class="btn btn-azure btn-m " style="margin-bottom: -1px;">
                                        <i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?>
                                    </a>
                            
                                    <a href="#" onClick="warning('<?php echo \think\Lang::get('delete_confirm'); ?>', '<?php echo url('model_type/del',array('id'=>$vo['id'])); ?>')" class="btn btn-darkorange  btn-m" style="margin-bottom: -1px;">
              ...
              <!--      <a  onclick='(function(){$("form").attr("action","<?php echo url("delMuti"); ?>");;$("#myform").submit();})();' class="btn btn-darkorange">删除</a>
                  -->
    ...
    function del_arr(){
            if($(":input:checkbox:checked[data-tog='ss']").length>0){               
                $("form").attr("action","<?php echo url('delMuti'); ?>");
                $("#myform").submit();
            }else{
        ...
        function sort_arr(){            
                $("form").attr("action","<?php echo url('resort'); ?>");
                $("#myform").submit();
        }
