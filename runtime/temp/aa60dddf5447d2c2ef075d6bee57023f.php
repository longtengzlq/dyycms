<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"C:\myweb\TP\public/../application/admin\view\article\list.html";i:1496883992;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>"><?php echo \think\Lang::get('system'); ?></a>
                                        ...
                                        <li class="active"><?php echo \think\Lang::get('article_list'); ?></li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="<?php echo \think\Lang::get('add'); ?>" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('article/add',array('language_id'=>$language_id)); ?>'"> <i class="fa fa-plus"></i> <?php echo \think\Lang::get('add'); ?>
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover ">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('title'); ?></th>
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('author'); ?></th>
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('category'); ?></th>
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('category_lang'); ?></th>                               
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('art_status'); ?></th>                               
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('release_date'); ?></th>                               
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('is_recommond'); ?></th>                               
                                <th class="text-center" style="vertical-align: middle"><?php echo \think\Lang::get('thumb'); ?></th>                               
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"  style='vertical-align: middle;font-size: 13px'><?php echo $vo['title']; ?></td>
                                <td align="center"  style='vertical-align: middle;font-size: 13px'><?php echo $vo['author']; ?> </td>
                                <td align="center"  style='vertical-align: middle;font-size: 13px'><?php echo $vo['category']['cate_name']; ?> </td>
                                 <td align="center"  style='vertical-align: middle;font-size: 13px'><?php echo $vo['language']['brief_name']; ?></td>
                                 ...
                                 <td align="center"  style='vertical-align: middle;font-size: 13px'><?php echo date("Y-m-d",$vo['release_date']); ?> </td>   
                                 <td align="center"  style='vertical-align: middle;font-size: 13px'>
                                     <label >
                                         <input class="checkbox-slider yesno colored-success " style="left: inherit"  id='is_recommend_<?php echo $vo['id']; ?>'  onclick="set_status(<?php echo $vo['id']; ?>,this)"   name='is_recommend' <?php if($vo['is_recommend'] == 1): ?>checked="checked"<?php endif; ?>type="checkbox">
                                        <span class="text" style="margin-bottom: -13px"></span>
                                    </label>
                                </td>
                                <td align="center"  style='vertical-align: middle;font-size: 13px'>
                                ...
                                <td align="center" class="buttons-preview"  style='vertical-align: middle;font-size: 13px'>
                                    <a href="<?php echo url('article/edit',array('id'=>$vo['id'],'language_id'=>$vo['language_id'])); ?>" class="btn btn-azure btn-m " style="margin-bottom: -1px;">
                                        <i class="fa fa-edit"></i> <?php echo \think\Lang::get('edit'); ?>
                                    </a>
                            
                                    <a href="#" onClick="warning('<?php echo \think\Lang::get('delete_confirm'); ?>', '<?php echo url('article/del',array('id'=>$vo['id'],'language_id'=>$vo['language_id'])); ?>')" class="btn btn-darkorange  btn-m" style="margin-bottom: -1px;">
    ...
    <script src="__JS__/mlcms.js"></script>
    <script>
