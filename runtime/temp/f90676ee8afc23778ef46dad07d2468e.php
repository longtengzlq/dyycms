<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"C:\myweb\TP\public/../application/admin\view\category\edit.html";i:1496883187;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption"><?php echo \think\Lang::get('category_edit'); ?></span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('category/edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span class="input-icon icon-right inverted">
                                    <input name="cate_name" required=""  type="text" value="<?php echo $results['cate_name']; ?>" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">  
                                <span class="input-icon icon-right inverted">
                                    <input name="language_name" required=""  type="text" disabled="disabled"  value="&nbsp;&nbsp;<?php echo $results['language']['brief_name']; ?> "   class="form-control">
                                    <i class="fa fa-language bg-orange"></i>
                                </span>
                                <input name="language_id" type="hidden"   value="<?php echo $results['language']['id']; ?> ">  
                            </div>
                            <p class="help-block col-sm-4 red">* <?php echo \think\Lang::get('required'); ?></p>
                        </div>   
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control" id="authority"  name="pid" style="border-radius:0px;">
                                    ...
                                    <option style="line-height: 20px;height: 20px;" value="<?php echo $cate['id']; ?>" <?php if($cate['id'] == $results['pid']): ?> selected <?php endif; ?> > <?php if($cate['level']>0) { echo str_repeat('&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;',$cate['level']-1).'&nbsp;&nbsp;&nbsp;|---';}?><?php echo $cate['cate_name']; ?></option>
                       ...
                       <div class="form-group" >
                            ...
                            <div class="col-sm-6">  
                                ...
                                <select class="form-control" id="model_type_id" onchange="display(this)" name="model_type_id" style="border-radius:0px;">
                                    ...
                                    <?php if(is_array($models) || $models instanceof \think\Collection || $models instanceof \think\Paginator): $i = 0; $__LIST__ = $models;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$model): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $model['id']; ?>" <?php if($results['model_type_id'] == $model['id']): ?> selected <?php endif; ?> ><?php if($language_id==1) { ?><?php echo $model['model_ch_name']; }else{ ?>
                         ...
                         <div class="form-group" id="content_group"  style="display:<?php if($results['model_type_id'] == 3): ?>  block;<?php else: ?>none;<?php endif; ?>" >
