<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"C:\myweb\TP\public/../application/admin\view\links\edit.html";i:1496118178;s:63:"C:\myweb\TP\public/../application/admin\view\common\header.html";i:1496919045;s:61:"C:\myweb\TP\public/../application/admin\view\common\left.html";i:1496908348;}*/ ?>
    <!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('links/lst',array('language_id'=>$language_id)); ?>"><?php echo \think\Lang::get('links'); ?></a>
                        </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo url('links/edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span class="input-icon icon-right inverted">
                                    <input name="name" required="" value="<?php echo $result['name']; ?>"  type="text" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">  
                                <span class="input-icon icon-right inverted">
                                    <input name="url" required="" type="text" value="<?php echo $result['url']; ?>" class="form-control ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4"><img src="<?php echo $result['thumb']; ?>" style="width: 40px;height: 35px;"></div>
                        </div>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">  
                                <span class="input-icon icon-right inverted">
                                    <select name="language_id" disabled="disabled"  class="col-sm-12" >
                                        ...
                                        <option  value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $result['language_id']): ?> selected<?php endif; ?>><?php echo $vo['brief_name']; ?></option>
